    ...
    public class CriadoresCaesDB:DbContext {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder) {
            ...
            modelBuilder.Entity<CriadoresCaes>().HasData(
               new CriadoresCaes { Id = 1, DataCompra = new DateTime(2019, 6, 15), CaesFK = 1, CriadoresFK = 1 },
               new CriadoresCaes { Id = 2, DataCompra = new DateTime(2019, 12, 9), CaesFK = 2, CriadoresFK = 2 },
               new CriadoresCaes { Id = 3, DataCompra = new DateTime(2011, 5, 21), CaesFK = 3, CriadoresFK = 4 },
               new CriadoresCaes { Id = 4, DataCompra = new DateTime(2008, 8, 7), CaesFK = 4, CriadoresFK = 5 },
               new CriadoresCaes { Id = 5, DataCompra = new DateTime(2012, 10, 20), CaesFK = 5, CriadoresFK = 6 },
               new CriadoresCaes { Id = 6, DataCompra = new DateTime(2010, 11, 30), CaesFK = 6, CriadoresFK = 7 },
               new CriadoresCaes { Id = 7, DataCompra = new DateTime(2011, 2, 9), CaesFK = 7, CriadoresFK = 8 },
               new CriadoresCaes { Id = 8, DataCompra = new DateTime(2013, 6, 21), CaesFK = 8, CriadoresFK = 9 },
               new CriadoresCaes { Id = 9, DataCompra = new DateTime(2011, 7, 9), CaesFK = 9, CriadoresFK = 10 },
               new CriadoresCaes { Id = 10, DataCompra = new DateTime(2017, 5, 20), CaesFK = 10, CriadoresFK = 5 },
               new CriadoresCaes { Id = 11, DataCompra = new DateTime(2018, 3, 5), CaesFK = 11, CriadoresFK = 8 }
            );
